...
9. Last RunAll in Studio: **391 passed, 0 failed** (08:40). WireDresser and WireDresserTest were created in Studio with multi_edit (comments trimmed there). TownBuilderTest now exists in Studio as a shortened copy (made with multi_edit); the disk file is the full one.
