...
**Reverted (never committed as features):** café tables in front of buildings on the promenade (06:31, X67: no building is close enough, needs a layout change); a stream request for the picker camera (07:19, X86: no effect, the horizon is atmosphere haze).
