...
9. Last RunAll in Studio: **388 passed, 0 failed** (08:36). TownBuilderTest now exists in Studio as a shortened copy (made with multi_edit); the disk file is the full one.
