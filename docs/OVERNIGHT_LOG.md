...
15. New sounds were chosen without being heard (the agent can't listen): train rumble (X172, "L Pass Bys 1"), playground loop (X174, "Park Playgrounds 1"), station bed (X173, an American subway platform clip), and the home near-miss groan (X183, the goal cheer slowed to 0.72x). *Rec: stand by the train, a play area and the station for 20 s each; if any sounds wrong, say which and the agent will swap the clip or drop the volume.*
