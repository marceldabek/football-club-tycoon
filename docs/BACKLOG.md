...
- [ ] X45 Parked cars are nearly all the orange one-mesh hatchback now (Mill Street reads monotone); find a second cheap car kit or tint copies (the white hatchback is 153 parts) `[studio]` S
