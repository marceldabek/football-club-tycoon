...
- [ ] X48 Street and planter trees are lollipops (trunk + 1-2 balls); RivermereCenter.png has loose, leafy crowns. Try 3-4 overlapping smaller balls at offsets per tree within the tree part budget `[studio]` S
