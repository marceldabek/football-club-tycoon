...
- [ ] X100 E10 "cables": no telegraph poles or overhead phone wires on the residential streets. A few poles with thin sagging wire segments on some terrace streets, Decor `[studio]` S
- [ ] X101 E2 list names a takeaway; the high street has none. A chippy or kebab shopfront with a lit sign among the ShopBuilder uses `[studio]` S
