...
- [x] X66 (06:05 primitive `RiverDresser.heritageLamp`, 7 parts or 9 with a basket on every other lamp, instead of the 36-part kit; 23 lamps, +47 parts; the navy banner is not done) Riverside promenade lamps are the modern TerraceLamp box; RivermereRiverside.png has black heritage lanterns with hanging baskets and a navy banner `[studio]` S
