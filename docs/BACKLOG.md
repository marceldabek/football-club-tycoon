...
- [ ] X66 Riverside promenade lamps are the modern TerraceLamp box; RivermereRiverside.png has black heritage lanterns with hanging baskets and a navy banner. Swap to the LampVictorian kit (already used on Mill Street) and hang a basket on every other one, checking the part count `[studio]` S
