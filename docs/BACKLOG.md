...
- [ ] X75 (06:25 brick name wall with the nearest road's plate beside each district stone: ELM GROVE, LUNE STREET, WEIR ROAD; still open: grass verges) Northfields vs RivermereNorthfields.png, still missing: a low brick corner wall with a street name plate (HAYFIELD CLOSE style) at the estate entrance, and grass verges between pavement and road on the estate roads `[studio]` S
