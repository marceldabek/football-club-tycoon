...
- [ ] X47 (04:09 planter flowers done; 04:10 shelter adverts done; still open: hanging baskets on lamp posts, lollipop trees) RivermereCenter.png vs the square: street tree pits are bare concrete boxes (reference: stone planters full of flowers), few hanging baskets on lamp posts, bus shelter has no advert panel, trees are lollipops `[studio]` M
