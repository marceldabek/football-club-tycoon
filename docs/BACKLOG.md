...
- [ ] X57 Northfields vs RivermereNorthfields.png: no play area with swings/slide and railings, no porch canopies over the semis' doors, flower borders in front gardens are bare lawn `[studio]` M
