...
- [ ] X73 (06:17 finger post by the stop: Town Centre / Car Park / Industrial Estate / Riverside, shared SquareDresser.fingerPost; 06:19 double yellow lines inside both kerbs of the straight, broken for the bus bay and lay-by; still open: a flower basket over the kiosk, the raised platform wall with railings and ivy seen above the frontage) Station vs RivermereStation.png `[studio]` S
