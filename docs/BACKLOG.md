...
- [ ] X55 (04:37 unit numbers + brick plinths; 04:39 lorries in the 4 wide warehouse yards; 05:46 forklifts in every third lorry-free yard; still open: palisade fencing (needs a pale texture or many parts), mini roundabout at Foundry Way x Estate Road (client traffic has no island avoidance, so a planted island would have cars driving through it)) Industrial estate vs rivermer.industrialestate.png: sheds have no unit numbers or brick plinth courses, no palisade yard fencing with gates, no lorries / pallets / forklifts in the yards, no small roundabout with a planted island at the estate road entrance `[studio]` M
