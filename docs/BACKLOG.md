...
- [ ] X55 (04:37 unit numbers + brick plinths; 04:39 lorries in the 4 wide warehouse yards; 05:46 forklifts in every third lorry-free yard; 06:53 Foundry Way Roundabout (radius 16, grass island) at the estate entrance: traffic drives over its island like every other roundabout's, so it is no worse than the existing ones; still open: palisade fencing (needs a pale texture or many parts)) Industrial estate vs rivermer.industrialestate.png: sheds have no unit numbers or brick plinth courses, no palisade yard fencing with gates, no lorries / pallets / forklifts in the yards, no small roundabout with a planted island at the estate road entrance `[studio]` M
