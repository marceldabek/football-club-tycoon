...
- [ ] X55 (04:37 unit numbers + brick plinths done; still open: palisade fencing, lorries/forklifts, entrance mini roundabout) Industrial estate vs rivermer.industrialestate.png: sheds have no unit numbers or brick plinth courses, no palisade yard fencing with gates, no lorries / pallets / forklifts in the yards, no small roundabout with a planted island at the estate road entrance `[studio]` M
