...
- [ ] X77 (06:39 the 8 3G lamp heads carry the FloodHead tag, so evening looks light them; still open: car park, paths) Sports centre follow-ups: its car park (the map shows one beside the hall), paths between the pitches, and floodlight tags so the 3G masts light up for evening fixtures (Scenery.FLOOD_HEAD_TAG) `[studio]` S
