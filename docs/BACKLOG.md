...
- [ ] X67 (06:31 tried cafe tables where a building backs onto the promenade and reverted: no pub/shop/flats block is within 8 of the promenade. The riverside flats sit 40+ behind it with the marina gardens between, and "waterfront flats" and "pub and cafes" are 70+ away, so the only match was the marina block. Needs a TownLayout change to bring a pub/cafe block to the promenade edge, checked against TownLayoutTest overlaps) The buildings along the promenade's west end show blank brick sides to the river (Riverside_fixed_1 at (-170, 8, 362)); RivermereRiverside.png has a pub, deli and café fronting the promenade with outdoor tables and A-boards. Needs a river-facing shopfront or a forecourt set on the promenade side `[studio]` M
