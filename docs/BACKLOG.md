...
- [ ] X96 Quality Low only hides ~2% of what a client renders: at the market square 15,607 visible parts on High vs 15,233 on Low (08:13). Decor is small; the weight is the Mill Street kit Dressing (8,371 parts) and terrace rows. For phones, Low needs a bigger lever: a smaller streaming radius, or hiding the kit Dressing rows beyond ~300 studs on Low. Decision in question 11 `[studio]` M
