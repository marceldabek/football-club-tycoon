...
- [ ] X73 (06:17 finger post by the stop: Town Centre / Car Park / Industrial Estate / Riverside, shared SquareDresser.fingerPost) Station vs RivermereStation.png, still missing: a finger post by the station (Town Centre / Car Park / Industrial Estate; SquareDresser already builds one), double yellow lines along Station Road's kerbs, a flower basket over the kiosk, and the raised platform wall with railings and ivy seen above the frontage `[studio]` S
