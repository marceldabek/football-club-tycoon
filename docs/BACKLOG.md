...
- [ ] X64 Some industrial shed yards run past their block: at Mill Lane Motors (-1521, -121) the yard slab and mesh fence sit on the pavement and a fence corner post stands in the Estate Road carriageway (Forklift_1). Clamp YARD_DEPTH to the block (or push the shed back) the way fitPair does for semis `[studio]` S
