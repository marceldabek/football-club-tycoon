...
- [ ] X50 (04:21: verge paved in 14 strips; still open: newsagent kiosk, taxi-rank and BUS STOP road markings) Station frontage vs RivermereStation.png: a grass strip separates Station Road's pavement from the paved forecourt (reference: paved to the kerb), no newsagent kiosk, no taxi-rank / BUS STOP road markings `[studio]` M
