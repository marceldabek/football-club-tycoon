...
- [ ] X47 (04:09: town-centre planter trees now have soil + a flower bed; still open: baskets, shelter advert, trees) RivermereCenter.png vs the square: street tree pits are bare concrete boxes (reference: stone planters full of flowers), few hanging baskets on lamp posts, bus shelter has no advert panel, trees are lollipops `[studio]` M
